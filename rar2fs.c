...
*
****************************************************************************/
static inline void __invalidate_cloak(const char *path)
{
        char *cloak;
...
*
****************************************************************************/
static void __attribute__((unused)) __invalidate_cloak_for_file(const char *path)
{
        char *safe_path;
        safe_path = strdup(path);
        __invalidate_cloak(dirname(safe_path));
        free(safe_path);
}
